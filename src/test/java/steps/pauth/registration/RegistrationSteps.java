package steps.pauth.registration;

import steps.pauth.registration.model.request.PhoneVerifyRequestBody;
import steps.pauth.registration.model.request.RegistrationRequestBody;
import steps.pauth.registration.model.request.UserRequestBody;
import steps.pauth.registration.model.response.PhoneVerifyResponseBody;
import steps.pauth.registration.model.response.RegistrationResponseBody;
import steps.pauth.registration.model.response.UserResponseBody;
